...
class Marketify_Setup {
    ...
    public function init() {
        ...
        $this->steps = array(
            'install-plugins' => array(
                ...
                'documentation' => array(
                    'Easy Digital Downloads' => 'http://listify.astoundify.com/article/228-wp-job-manager',
            ...
            'support-us' => array(
                ...
                'completed' => 'na',
                'documentation' => array(
                    'Leave a Positive Review' => 'http://bit.ly/rate-marketify',
                    'Contribute Your Translation' => 'http://bit.ly/translate-marketify'
                )
            )
        );
    ...
    ?>
        ...
        <p class="about-text"><?php printf( __( 'Creating a digital marketplace has never been easier with Marketify&mdash;Use the steps below to finish setting up your new website. If you have more questions please <a href="%s">review the documentation</a>.', 'marketify' ), 'http://marketify.astoundify.com' ); ?></p>

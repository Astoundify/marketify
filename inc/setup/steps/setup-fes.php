...
<ol>
<li><a href="<?php echo admin_url( 'nav-menus.php' ); ?>">Add the Frontend Submissions pages to your Menu</a></li>
<li><a href="<?php echo admin_url( 'admin.php?page=fes-settings' ); ?>">Turn off the Frontend Submission's CSS</a></li>

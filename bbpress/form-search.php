...
<form role="search" method="get" id="bbp-search-form" class="search-form" action="<?php bbp_search_url(); ?>">
	<label>
		...
		<input type="search" id="bbp_search" class="search-field" placeholder="<?php echo esc_attr_x( 'Search', 'placeholder', 'marketify' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="bbp_search" title="<?php echo esc_attr_x( 'Search for:', 'label', 'marketify' ); ?>">
	</label>

...
<header class="content-grid-download__entry-header">
    <h3 class="entry-title <?php if ( 'on' == marketify_theme_mod( 'downloads-archives-truncate-title' ) ) : ?> entry-title--truncated<?php endif; ?>"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h3>
